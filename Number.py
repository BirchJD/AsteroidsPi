...
#/*****************************/
      ...
      for self.Digit in range(10):
         self.Divide = self.TempValue % 10
         for self.Count in range(self.Decimal[self.Divide][self.MAX_POINTS].x):
            self.DisplayFrame[self.Digit][self.Count].x = self.Decimal[self.Divide][self.Count].x + self.xOffset + (10 - self.Digit) * 3 * self.Scale
...
#/*************************/
         Common.DrawLines(ThisSurface, self.OldFrame[self.Digit], self.OldFrame[self.Digit][self.MAX_POINTS].x, (0x00, 0x00, 0x00))

#  /***************************/
# /* Draw the current score. */
#/***************************/
         Common.DrawLines(ThisSurface, self.DisplayFrame[self.Digit], self.DisplayFrame[self.Digit][self.MAX_POINTS].x, (0x00, 0xFF, 0x00))
