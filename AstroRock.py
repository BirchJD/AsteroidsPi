...
class AstroRock:
   ...
   def SetArea(self, Desktop, NewxOffset, NewyOffset, NewSize):
      ...
      while self.xVelocity == 0 or self.yVelocity == 0:
         self.xVelocity = random.randrange(5 * (self.Size + 1)) - 2 * (self.Size + 1)
         self.yVelocity = random.randrange(5 * (self.Size + 1)) - 2 * (self.Size + 1)
   ...
   def Collide(self, xPos, yPos, Width, Height):
      ...
      if self.Size < self.INACTIVE:
         ...
         if self.Collision == True:
            ...
            self.yVelocity = 0
            while self.xVelocity == 0 or self.yVelocity == 0:
               self.xVelocity = random.randrange(17 * (self.Size + 1)) - 8 * (self.Size + 1)
               self.yVelocity = random.randrange(17 * (self.Size + 1)) - 8 * (self.Size + 1)
